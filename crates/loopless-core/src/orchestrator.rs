...
use loopless_observation::detection::{
...
use loopless_observation::history::{HistoryStore, InMemoryHistoryStore};
use loopless_observation::pipeline::{ObservationPipeline, PipelineConfig};
...
impl Orchestrator {
    pub fn new(
        ...
        if config.enable_budget {
            detectors.push(Box::new(loopless_observation::detection::BudgetDetector::new()));
        }
